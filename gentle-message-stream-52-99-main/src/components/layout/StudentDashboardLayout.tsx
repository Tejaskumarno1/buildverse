  ...
  const navSections: NavSection[] = [
    {
      items: [
        ...
        { name: "Exams & Tests", icon: ClipboardCheck, path: "/my-exams" },
                        ...
                        >
                          <div className="flex items-start gap-3">
                            <div className="flex-shrink-0">
                              {notification.type === 'success' && <Bell className="h-4 w-4 text-green-500" />}
                              {notification.type === 'warning' && <Bell className="h-4 w-4 text-yellow-500" />}
                              {notification.type === 'error' && <Bell className="h-4 w-4 text-red-500" />}
