    ...
    Tables: {
      ...
      interview_results: {
        Row: {
          ...
          questions_auto_submitted: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "interview_results_application_id_fkey"
            columns: ["application_id"]
            isOneToOne: false
            referencedRelation: "job_applications"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "interview_results_job_id_fkey"
            columns: ["job_id"]
            isOneToOne: false
            referencedRelation: "jobs"
            referencedColumns: ["id"]
      ...
      jobs: {
        Row: {
          ...
          dynamic_questions_enabled: boolean | null
          ...
          title: string
          total_interview_questions: number | null
          typing_test_duration: number | null
          typing_test_enabled: boolean | null
          updated_at: string
      ...
      typing_test_results: {
        Row: {
          ...
          application_id: string | null
          auto_submitted: boolean | null
          browser_focus_lost_count: number | null
          ...
          minimum_accuracy_required: number
          minimum_wpm_required: number
          paragraph_used: string
          passed: boolean
        ...
        Relationships: [
          {
            foreignKeyName: "typing_test_results_application_id_fkey"
            columns: ["application_id"]
            isOneToOne: false
            referencedRelation: "job_applications"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "typing_test_results_job_id_fkey"
            columns: ["job_id"]
            isOneToOne: false
            referencedRelation: "jobs"
            referencedColumns: ["id"]
